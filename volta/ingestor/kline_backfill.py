...
from volta.config.chart_intervals import (
    CHART_INTERVALS,
...
from volta.ingestor.kline_hub import current_bucket_open_time, get_kline_hub
...
class KlineBackfillService:
    ...
    async def _backfill_series(
        ...
        if forming is not None:
            hub = get_kline_hub()
            from volta.ingestor.kline_hub import LiveCandle
