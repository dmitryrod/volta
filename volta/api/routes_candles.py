...
from volta.config.assets import validate_base, validate_option_symbols
from volta.database import Database
from volta.database.repositories.snapshot_repository import INTERVAL_SECONDS
from volta.ingestor.kline_hub import get_kline_hub
...
def get_templates() -> Jinja2Templates:
    from volta.__main__ import templates
    return templates
